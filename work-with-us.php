        ...
        <div class="container text-justify">
            <div class="row">
                <div class="col-12 col-md-6">
                    <h1 class="display-2 fw-bold">WORK WITH US</h1>
                    <p></p>
                </div>
            </div>
            <div class="mt-5">
                <a href="#" class="btn btn-lg btn-outline-light mb-3 me-3">Internship</a>
                <a href="careers" class="btn btn-lg btn-outline-light mb-3">Careers</a>
            </div>
        </div>
    </main>
