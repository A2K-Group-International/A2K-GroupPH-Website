...
<body>
    ...
    <!--MAIN-->
    <main>
        <section class="container min-vh-100 mt-5">
            <h2 class="pt-5 text-center">There are no open job posts at this time. Please check regularly for new job listings. Alternatively feel free to drop us a message with your cv and cover letter at hr@a2kgroup.org if you would like to work with us.</h2>
        </section>
    </main>
