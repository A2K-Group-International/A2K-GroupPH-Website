...
<body>
    ...
    <main>
        <!--SECTION 1-->
        <section class="ourStory_section1">
            <div class="container ourStory_section1_container">
                        ...
                        <div class="ourStory_image">
                            <div class="ratio ratio-4x3">
                                <img src="./images/who-we-are.jpg"
                                    class="object-fit-cover" alt="pointing-on-laptop">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!--SECTION 2-->
        <section class="ourStory_section2">
            <div class="container text-center">
                <div class="row py-5 justify-content-center gap-5">
                    <div class="col-12 col-md-4">
                        <h2 class="fw-bold mb-4">OUR VISION</h2>
                        <p class="text-center">To empower others through the transition towards digitalization with accessible solutions so they can optimize their processes to serve pressing social and commercial needs.​</p>
                    </div>
                    <div class="col-12 col-md-4">
                        <h2 class="fw-bold mb-4">OUR MISSION</h2>
                        <p class="text-center">We deliver digitalization services to organizations by providing software and hardware solutions, training in creating digital tools, and investing in future digitalization ventures​.</p>
                    </div>
                    <div class="col-12 col-md-4">
                        <h2 class="fw-bold mb-4">OUR CORE VALUES</h2>
                        <p class="text-center"><b>Family</b><br> Fostering a caring community with mutual respect, empathy, and positivity.</p>
                        <p class="text-center mt-1"><b>Innovation</b><br> Professionally pursuing excellence and resilience through continuous learning and growth.</p>
                        <p class="text-center mt-1"><b>Joy</b><br> Living each day as an opportunity to celebrate our people, our work, and our purpose.</p>
